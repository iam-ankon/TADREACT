...
const LoginPage = () => {
  ...
  // FIXED: Handle Enter key press - submit on last step, next on previous steps
      ...
      return (
        <div className="input-group department-dropdown-container">
          <label
            ...
            className={currentField.required ? "required" : ""}
          >
            {currentField.label}
          </label>
      ...
      <div className="header">
        ...
        <div className="login-container">
          ...
          <form onSubmit={handleLogin}>
            <div className="field-transition">{renderCurrentField()}</div>
            ...
            <div className="form-info">
              ...
              <p>
                <strong>Required fields:</strong> Employee ID, Username,
                Password
              </p>
            </div>
          </form>
