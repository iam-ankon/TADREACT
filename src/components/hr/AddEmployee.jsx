...
const AddEmployee = () => {
    ...
    useEffect(() => {
        const fetchCompanies = async () => {
            try {
                const response = await axios.get("http://119.148.12.1:8000/api/hrms/api/tad_groups/");
        ...
        const fetchCustomers = async () => {
            try {
                const response = await axios.get("http://119.148.12.1:8000/api/hrms/api/customers/");
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post("http://119.148.12.1:8000/api/hrms/api/employees/", employeeFormData, {
