...
const AddTermination = () => {
  ...
  useEffect(() => {
    axios
      .get("http://119.148.51.38:8000/api/hrms/api/tad_groups/") // Replace this URL with your API for TAD group companies
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        "http://119.148.51.38:8000/api/hrms/api/employee_termination/",
        formData
      )
      .then(() => {
