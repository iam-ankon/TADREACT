...
const EditAppraisal = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://119.148.12.1:8000/api/hrms/api/performanse_appraisals/${id}/`)
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`http://119.148.12.1:8000/api/hrms/api/performanse_appraisals/${id}/`, formData);
