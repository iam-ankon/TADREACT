        ...
        <div style={styles.section}>
          ...
          <div style={styles.datesGrid}>
            ...
            <div style={styles.dateCard}>
              ...
              <div style={styles.formulaHint}>→ Calculates: Fabric LC, Fabric ETD, PPS</div>
            </div>
          </div>
        </div>
