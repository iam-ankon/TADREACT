...
const AddAttachmentInquiry = () => {
    ...
    useEffect(() => {
        const fetchAttachments = async () => {
            try {
                const response = await axios.get('http://119.148.12.1:8000/api/merchandiser/api/inquiry_attachment/');
    ...
    const handleSave = async (id) => {
        try {
            await axios.patch(`http://119.148.12.1:8000/api/merchandiser/api/inquiry_attachment/${id}/`, {
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Are you sure you want to delete this attachment?')) {
            try {
                await axios.delete(`http://119.148.12.1:8000/api/merchandiser/api/inquiry_attachment/${id}/`);
