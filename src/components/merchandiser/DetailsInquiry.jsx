        ...
        <div style={{ display: "flex", gap: "20px", marginBottom: "20px" }}>
          ...
          >
            ...
            >
              <div>
                <p style={{ margin: "8px 0", fontSize: "14px" }}>
                  <strong>Fabric 1:</strong> {inquiry.fabric1 || "-"}
                </p>
                <p style={{ margin: "8px 0", fontSize: "14px" }}>
                  <strong>Fabric 2:</strong> {inquiry.fabric2 || "-"}
                </p>
              </div>
              <div>
                <p style={{ margin: "8px 0", fontSize: "14px" }}>
                  <strong>Fabric 3:</strong> {inquiry.fabric3 || "-"}
                </p>
                <p style={{ margin: "8px 0", fontSize: "14px" }}>
                  <strong>Fabric 4:</strong> {inquiry.fabric4 || "-"}
                </p>
              </div>
            </div>
            <p style={{ margin: "8px 0", fontSize: "14px" }}>
            ...
            >
              <div>
                <p style={{ margin: "8px 0", fontSize: "14px" }}>
                  <strong>Proposed Shipment Date:</strong>{" "}
                  {inquiry.proposed_shipment_date || "-"}
                </p>
                <p style={{ margin: "8px 0", fontSize: "14px" }}>
                  <strong>Confirmed Price Date:</strong>{" "}
                  {inquiry.confirmed_price_date || "-"}
                </p>
              </div>
              <div>
                <p style={{ margin: "8px 0", fontSize: "14px" }}>
                  <strong>Tech Ref Date:</strong> {inquiry.techrefdate || "-"}
                </p>
                <p style={{ margin: "8px 0", fontSize: "14px" }}>
