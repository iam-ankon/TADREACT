...
const AddOrder = () => {
  ...
  const fetchCustomers = async () => {
    try {
      ...
      setSnackbar({ open: true, message: "Error loading customers", type: "error" });
    } finally {
  ...
  const validateStep = () => {
    if (activeStep === 0) {
      ...
      if (colorSizeGroups.length === 0 || colorSizeGroups.every(g => !g.color)) {
        setSnackbar({ open: true, message: "Please add at least one color with quantity", type: "warning" });
        return false;
      }
    }
    return true;
        ...
        return (
          <div style={styles.stepContent}>
            <div style={styles.formGrid}>
              {/* Basic Information Fields - Same as before */}
              <div style={styles.formField}>
                <label style={styles.formLabel}>Style <span style={styles.required}>*</span></label>
                <div style={styles.inputWrapper}>
                  <FaBoxes style={styles.inputIcon} />
                  <input type="text" name="style" value={formData.style} onChange={handleChange} placeholder="Enter style name" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  ...
                  <input type="text" name="po_no" value={formData.po_no} onChange={handleChange} placeholder="Enter PO number" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  ...
                  <input type="text" name="department" value={formData.department} onChange={handleChange} placeholder="Enter department" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  <FaBuilding style={styles.inputIcon} />
                  <select name="customer" value={formData.customer} onChange={handleChange} style={styles.select} disabled={customersLoading}>
                    <option value="">Select Customer</option>
                    {customers.map((customer) => {
                      let displayName = customer.customer_name || customer.name || `Customer ${customer.id}`;
                      if (typeof displayName === "object") displayName = displayName.customer_name || displayName.name || `Customer ${customer.id}`;
                      return <option key={customer.id} value={customer.id}>{displayName}</option>;
                    })}
                  </select>
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  <FaClipboardList style={styles.inputIcon} />
                  <input type="text" name="ref_no" value={formData.ref_no} onChange={handleChange} placeholder="Enter reference number" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  ...
                  <input type="text" name="shipment_month" value={formData.shipment_month} onChange={handleChange} placeholder="e.g., January 2024" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  ...
                  <input type="text" name="gender" value={formData.gender} onChange={handleChange} placeholder="Enter gender" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  <FaShoppingCart style={styles.inputIcon} />
                  <input type="text" name="item" value={formData.item} onChange={handleChange} placeholder="Enter item name" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formFieldFull}>
                ...
                <div style={styles.inputWrapper}>
                  <FaIndustry style={styles.inputIcon} />
                  <textarea name="fabrication" value={formData.fabrication} onChange={handleChange} placeholder="Enter fabrication details..." rows={3} style={styles.textarea} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  ...
                  <input type="text" name="wgr" value={formData.wgr} onChange={handleChange} placeholder="Enter WGR" style={styles.input} />
                </div>
              </div>
            </div>
          </div>
            ...
            <div style={styles.formGrid}>
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  ...
                  <input type="number" name="unit_price" value={formData.unit_price} onChange={handleChange} placeholder="0.00" step="0.01" min="0" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  <FaBoxes style={styles.inputIcon} />
                  <input type="number" name="total_qty" value={formData.total_qty} onChange={handleChange} placeholder="0" min="0" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  <FaDollarSign style={styles.inputIcon} />
                  <input type="number" name="total_value" value={formData.total_value} onChange={handleChange} placeholder="0.00" step="0.01" min="0" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  <FaIndustry style={styles.inputIcon} />
                  <input type="number" name="factory_value" value={formData.factory_value} onChange={handleChange} placeholder="0.00" step="0.01" min="0" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  ...
                  <input type="number" name="shipped_qty" value={formData.shipped_qty} onChange={handleChange} placeholder="0" min="0" style={styles.input} />
                </div>
              </div>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  <FaDollarSign style={styles.inputIcon} />
                  <input type="number" name="shipped_value" value={formData.shipped_value} onChange={handleChange} placeholder="0.00" step="0.01" min="0" style={styles.input} />
                </div>
              </div>
            </div>
          ...
          <div style={styles.stepContent}>
            <div style={styles.formGrid}>
              ...
              <div style={styles.formField}>
                ...
                <div style={styles.inputWrapper}>
                  <FaUser style={styles.inputIcon} />
                  <input type="text" name="group_name" value={formData.group_name} onChange={handleChange} placeholder="Enter group name" style={styles.input} />
                </div>
              </div>
            </div>
          </div>
            ...
            <div style={styles.formGrid}>
              <div style={styles.formFieldFull}>
                ...
                <div style={styles.inputWrapper}>
                  ...
                  <textarea name="physical_test" value={formData.physical_test} onChange={handleChange} placeholder="Enter physical test results..." rows={3} style={styles.textarea} />
                </div>
              </div>
              ...
              <div style={styles.formFieldFull}>
                ...
                <div style={styles.inputWrapper}>
                  <FaFlask style={styles.inputIcon} />
                  <textarea name="chemical_test" value={formData.chemical_test} onChange={handleChange} placeholder="Enter chemical test results..." rows={3} style={styles.textarea} />
                </div>
              </div>
              ...
              <div style={styles.formFieldFull}>
                ...
                <div style={styles.inputWrapper}>
                  <FaClipboardList style={styles.inputIcon} />
                  <textarea name="during_production_inspection" value={formData.during_production_inspection} onChange={handleChange} placeholder="Enter production inspection details..." rows={3} style={styles.textarea} />
                </div>
              </div>
              ...
              <div style={styles.formFieldFull}>
                ...
                <div style={styles.inputWrapper}>
                  <FaClipboardList style={styles.inputIcon} />
                  <textarea name="final_random_inspection" value={formData.final_random_inspection} onChange={handleChange} placeholder="Enter final inspection results..." rows={3} style={styles.textarea} />
                </div>
              </div>
              ...
              <div style={styles.formFieldFull}>
                ...
                <div style={styles.inputWrapper}>
                  ...
                  <textarea name="remarks" value={formData.remarks} onChange={handleChange} placeholder="Enter any additional remarks..." rows={3} style={styles.textarea} />
                </div>
              </div>
            </div>
          </div>
    ...
    <div style={styles.appContainer}>
      ...
      <div style={styles.mainContent}>
        <div style={styles.addOrderContainer}>
            ...
            <div style={styles.navigationButtons}>
              ...
              {activeStep === steps.length - 1 ? (
                <button style={styles.btnPrimary} onClick={handleSubmit} disabled={loading}>
                  {loading ? "Creating..." : <><FaSave style={{ marginRight: "8px" }} /> Create Order</>}
                </button>
              ) : (
          ...
          {/* Snackbar */}
          {snackbar.open && (
            <div style={{ ...styles.snackbar, backgroundColor: snackbar.type === "success" ? "#10b981" : snackbar.type === "error" ? "#ef4444" : "#f59e0b" }}>
...
const styles = {
  ...
  stepItemActive: { cursor: "default" },
  stepItemCompleted: { cursor: "pointer" },
  stepIcon: {
    width: "40px",
    height: "40px",
    borderRadius: "50%",
