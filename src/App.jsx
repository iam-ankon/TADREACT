...
import SalaryEmailModal from "./components/hr/SalaryEmailModal.jsx";
...
import InquiryForm from "./components/merchandiser/InquiryForm";
...
import DevelopmentSamples from "./components/merchandiser/DevelopmentSamples.jsx";
import InquiryCosting from "./components/merchandiser/InquiryCosting.jsx";
import InquiryCostingList from "./components/merchandiser/InquiryCostingList.jsx";
import BulkCosting from "./components/merchandiser/BulkCosting.jsx";
import TNADashboard from "./components/merchandiser/TNADashboard.jsx";
import TNAForm from "./components/merchandiser/TNAForm.jsx";
import TNADetails from "./components/merchandiser/TNADetails.jsx";
import CommissionList from "./components/merchandiser/CommissionList.jsx";
import CommissionForm from "./components/merchandiser/CommissionForm.jsx";
import CommissionDetails from "./components/merchandiser/CommissionDetails.jsx";
...
import SalaryComparison from "./components/tax/SalaryComparison.jsx";
import SalaryCertificateGenerator from "./components/tax/SalaryCertificateGenerator.jsx";
    ...
    <>
      ...
      <div className="container">
        <Routes>
          ...
          />
          <Route
            path="/performanse_appraisal"
            element={
              <ProtectedRoute>
                <PerformanseAppraisal />
              </ProtectedRoute>
            }
          />
          <Route
            path="/performanse_appraisal/:id"
            element={
              <ProtectedRoute>
                <PerformanseAppraisal />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/terminated-employee-archive"
            element={
              <ProtectedRoute>
                <TerminatedEmployeeArchive />
              </ProtectedRoute>
            }
          />
          <Route
            path="/salary-email-modal"
            element={
              <ProtectedRoute>
                <SalaryEmailModal />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/salary-certificate-generator"
            element={
              <ProtectedRoute>
          ...
          />
          <Route
            path="/inquiries/attachments"
            element={
              <ProtectedRoute>
                <AddAttachmentInquiry />
              </ProtectedRoute>
            }
          />
          <Route
          ...
          />
          <Route
            path="/inquiries/:inquiryId/costing"
            element={
              <ProtectedRoute>
                <InquiryCosting />
              </ProtectedRoute>
          ...
          <Route
            path="/tax-calculator/:employeeId"
            element={
              <ProtectedRoute>
                <TaxCalculators />
              </ProtectedRoute>
